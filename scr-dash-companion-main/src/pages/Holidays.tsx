      ...
      >
        <div className="bg-slate-900 p-8 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-white text-lg tracking-tight font-display uppercase">Holiday List</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-100">
                  <th className="text-left text-[11px] font-bold text-slate-400 uppercase tracking-widest py-4 px-6 font-display">#</th>
                  <th className="text-left text-[11px] font-bold text-slate-400 uppercase tracking-widest py-4 px-6 font-display">Holiday Name</th>
                  <th className="text-left text-[11px] font-bold text-slate-400 uppercase tracking-widest py-4 px-6 font-display">Date</th>
                  <th className="text-left text-[11px] font-bold text-slate-400 uppercase tracking-widest py-4 px-6 font-display">Day</th>
                  <th className="text-center text-[11px] font-bold text-slate-400 uppercase tracking-widest py-4 px-6 font-display">Type</th>
                </tr>
              </thead>
              <tbody>
