      ...
      >
        <div className="bg-slate-900 p-8 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-white text-lg tracking-tight font-display uppercase">Note Entry</h3>
        ...
        <div className="p-10 bg-white space-y-8">
          ...
          <div className="flex items-center gap-4 pt-8 border-t border-slate-50">
            <Button 
              ...
              className="btn-primary flex-1 h-14 rounded-2xl font-bold text-base transition-all hover:-translate-y-0.5 active:scale-95 group"
            >
