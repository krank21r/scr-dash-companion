        ...
        >
          <div className="flex items-center justify-between p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-lg font-display">Holidays</h3>
      ...
      >
        <div className="bg-slate-900 p-8 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-white text-lg tracking-tight font-display uppercase">About</h3>
        ...
        <div className="p-10 bg-white space-y-8">
          <div className="space-y-4">
            <h4 className="text-xl font-bold text-slate-900 font-display">Budget Section Portal</h4>
