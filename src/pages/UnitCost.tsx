    ...
    <div className="max-w-6xl mx-auto space-y-10 pb-20 px-4">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 font-display">Unit Cost</h1>
          </div>
        </div>
      ...
      >
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 font-display">Ingest Datastream</h2>
          ...
          >
            <div className="p-8 bg-slate-900 border-b border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-white text-lg tracking-tight font-display">Parsed Cost Registry</h3>
      ...
      {unitCosts.length === 0 && (
        <div className="py-20 text-center">
          ...
          <h3 className="text-xl font-bold text-slate-400 font-display uppercase tracking-[0.2em]">Registry Awaiting Data</h3>
        </div>
      )}
    </div>
  );
